  ...
  const testCases = [
    {
      ...
      testData: {
        ...
        expectedAmount: BigNumber.from("1319533772087105467"), // 1.31 LINK (to pay)
    ...
    },
    {
      ...
      testData: {
        ...
        fee: BigNumber.from("1000000000000000000"), // 1 LINK
        feeType: FeeType.FLAT,
        expectedAmount: BigNumber.from("1220152673752030858"), // 1.22 LINK (to pay)
        expectedDelta: BigNumber.from("0"), // 0 LINK
      },
    },
    {
      ...
      testData: {
        ...
        fee: BigNumber.from("1000000000000000000"), // 1 LINK
        feeType: FeeType.FLAT,
        expectedAmount: BigNumber.from("-679847326247969142"), // -0.68 LINK (to refund)
        expectedDelta: BigNumber.from("0"), // 0 LINK
      },
    },
    {
      ...
      testData: {
        ...
        expectedAmount: BigNumber.from("358329300608336510"), // 0.36 LINK (to pay)
        expectedDelta: BigNumber.from("0"), // 0 LINK
      },
    },
    {
      ...
      testData: {
        ...
        fee: BigNumber.from("1225"), // 12.25%
        feeType: FeeType.PERMIRYAD,
        expectedAmount: BigNumber.from("259024017727215261"), // 0.26 LINK (to pay)
        expectedDelta: BigNumber.from("0"), // 0 LINK
      },
    },
    {
      ...
      testData: {
        ...
        fee: BigNumber.from("1225"), // 12.25%
        feeType: FeeType.PERMIRYAD,
        expectedAmount: BigNumber.from("-1640975982272784739"), // -1.64 LINK (to refund)
        expectedDelta: BigNumber.from("0"), // 0 LINK
      },
    },
  ];
