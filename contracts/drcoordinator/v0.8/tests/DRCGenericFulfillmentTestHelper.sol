...
contract DRCGenericFulfillmentTestHelper is ChainlinkExternalFulfillmentCompatible {
    ...
    function setExternalPendingRequest(address _drCoordinator, bytes32 _requestId) external {
