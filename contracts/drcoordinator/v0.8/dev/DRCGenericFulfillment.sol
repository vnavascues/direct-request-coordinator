...
contract DRCGenericFulfillment is ConfirmedOwner, AccessControl, ChainlinkExternalFulfillmentCompatible {
    ...
    function setExternalPendingRequest(address _drCoordinator, bytes32 _requestId)
        external
        onlyRole(DRCOORDINATOR_ROLE)
    {
        _addPendingRequest(_drCoordinator, _requestId);
    }
